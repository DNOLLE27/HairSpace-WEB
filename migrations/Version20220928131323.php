 ...
 */
final class Version20220928131323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE droits (id INT AUTO_INCREMENT NOT NULL, drt_libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, utl_drt_id_id INT NOT NULL, utl_identifiant VARCHAR(255) NOT NULL, utl_email VARCHAR(255) NOT NULL, utl_mdp VARCHAR(255) NOT NULL, INDEX IDX_497B315E2E518BB1 (utl_drt_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
