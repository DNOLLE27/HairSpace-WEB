 ...
 */
final class Version20221005135158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD droit TINYINT(1) NOT NULL, DROP utl_drt_id_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD utl_drt_id_id INT NOT NULL, DROP droit');
